  ...
  public: {
    Tables: {
      ...
      developer_kpi_metrics: {
        ...
        Relationships: [
          {
            foreignKeyName: "developer_kpi_metrics_category_id_fkey"
            columns: ["category_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "developer_kpi_metrics_developer_kpi_id_fkey"
            columns: ["developer_kpi_id"]
            isOneToOne: false
            referencedRelation: "developer_kpis"
            referencedColumns: ["id"]
          },
        ]
      }
      developer_kpis: {
        ...
        Relationships: [
          {
            foreignKeyName: "developer_kpis_assigned_by_fkey"
            columns: ["assigned_by"]
            isOneToOne: false
            referencedRelation: "user_profiles"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "developer_kpis_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "user_profiles"
            referencedColumns: ["id"]
      ...
      kpi_categories: {
        ...
        Relationships: [
          {
            foreignKeyName: "kpi_categories_company_id_fkey"
            columns: ["company_id"]
            isOneToOne: false
            referencedRelation: "companies"
            referencedColumns: ["id"]
      ...
      kpi_metric_submissions: {
        Row: {
          ...
          status: Database["public"]["Enums"]["kpi_submission_status"]
          updated_at: string
        }
        Insert: {
          attachments?: Json | null
        ...
        Relationships: [
          {
            foreignKeyName: "kpi_metric_submissions_developer_id_fkey"
          ...
          {
            foreignKeyName: "kpi_metric_submissions_metric_id_fkey"
            columns: ["metric_id"]
            isOneToOne: false
            referencedRelation: "developer_kpi_metrics"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "kpi_metric_submissions_reviewer_id_fkey"
            columns: ["reviewer_id"]
            isOneToOne: false
            referencedRelation: "user_profiles"
            referencedColumns: ["id"]
      ...
      kpi_reviews: {
        Row: {
          ...
          id: string
          status: Database["public"]["Enums"]["kpi_review_status"]
        ...
        Relationships: [
          {
            foreignKeyName: "kpi_reviews_developer_kpi_id_fkey"
            columns: ["developer_kpi_id"]
            isOneToOne: false
            referencedRelation: "developer_kpis"
            referencedColumns: ["id"]
      ...
      kpi_template_metrics: {
        ...
        Relationships: [
          {
            foreignKeyName: "kpi_template_metrics_category_id_fkey"
            columns: ["category_id"]
            isOneToOne: false
            referencedRelation: "kpi_categories"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "kpi_template_metrics_template_id_fkey"
            columns: ["template_id"]
            isOneToOne: false
      ...
      kpi_templates: {
        Row: {
          company_id: string | null
          created_at: string
          cycle_type: Database["public"]["Enums"]["kpi_cycle_type"]
          id: string
          title: string
    ...
    Enums: {
      ...
      kpi_cycle_type: "QUARTERLY" | "HALF_YEARLY" | "ANNUAL" | "CUSTOM"
      kpi_review_status: "DRAFT" | "FINALIZED"
      kpi_status: "ACTIVE" | "COMPLETED" | "ARCHIVED"
